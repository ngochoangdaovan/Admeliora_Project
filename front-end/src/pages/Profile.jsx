            ...
            <div>
                <Grid
                 ...
                 gap = {20}>
                     ...
                     <div>
                     <h2 style ={{marginTop:"67px"}}>Giới Tính:
                     </h2>
                     ...
                     <div>
                        ...
                        <Link to =""> 
                        <h2 style ={{marginTop:"67px",textDecoration:"underline"}}>Lịch Sữ Giao Dịch</h2>
                        </Link>

                        <button style ={{height:"30px",width:"100px",borderRadius:"20px",backgroundColor:"white",marginTop:"60px"}}>Lưu</button>
                     </div>
                     </div>
                     ...
                     <div  className ="second_frame_profile">
                        ...
                        <div className="container_frame_profile">
                            ...
                            <img src={profileImg} alt="" id="img" className="img_user_input_profile" />
                            </div>
                            ...
                            <p style ={{marginTop:"20px"}}>Quản lý thông tin hồ sơ để bảo mật tài khoản</p>
                            </div>
                        </div>
                             ...
                             <div style ={{marginTop:"500px",textAlign:"center" }}>
                                <Link to = "/Login">
                                    <button style ={{height:"30px",width:"100px",borderRadius:"20px",backgroundColor:"white",marginTop:"60px"}} >log out</button>
                                </Link>
                        </div>
                     </div>
