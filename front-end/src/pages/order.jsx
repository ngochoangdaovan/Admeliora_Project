  ...
  <div>
      <Grid col={2}
        ...
        <div className = "first_order" >
            ...
            <div><input placeholder="Họ & Tên" className ="input_payment1"></input></div>
            <div><input placeholder="Email" className ="input_payment1"></input></div>
            <div><input placeholder="Số Điện Thoại" className ="input_payment1"></input></div>
            <div>
            ...
            <div><input placeholder="SỐ Nhà & Tên Đường" className ="input_payment1"></input></div>
            ...
            <label class="input_circle">Thanh Toán ThẻThẻ (ATM nội địa, Visa, MasterCard)
            ...
            <div style={{margin:"20px"}} >
                <label class="input_circle">Thanh Toán Khi Nhận Hàng (CODCOD)
                <input type="radio" name="radio"/>
                <span class="checkmark1"></span>
                </label>
        ...
        <div className = "second_order" >
            <div className = "frame_second_element">
                ...
                <div style ={{textAlign:"center"}}><h1>Đơn Hàng(map số lương)</h1></div>
                ...
                <div className ="frame_voucher_order">
                    <input className ="voucher_order" placeholder ="mã giảm giá"></input>
                ...
                <div><i onClick={() => come_back_cart()} class='bx bx-arrow-back' style={{fontSize:"40px"}}></i><h4> Quay lại giỏi hàng</h4></div>
                </div>
            </div>
        </div>
