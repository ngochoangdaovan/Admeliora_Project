    ...
    <Helmet title="News">
      ...
      <Grid col={2}
            ...
            <div className = "frame_img">
              <img className = "imgg" src = "./images/img_news/img_New_1.jpg" />
              <div className ="container_new">
                <p className = "content_new">summer sale up to 50%</p>
                    <p className = "content_new" style = {{paddingTop:"5px", paddingBottom:"5px"}}>thời gian: từ ngày 27/6-07/07</p>
                  <p className = "content_new"> link shope :  <Link className = "content_new"
