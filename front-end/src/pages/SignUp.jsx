      ...
      <Grid col={2} mdCol={2} smCol={1} gap={10}>
        ...
        <div className="frame_infor_sigup">
          <div style={{ textAlign: 'center' }}>
            <Link to="/">
              <img className="logo_sigup" src="./images/LOGOLOGIN.jpg" alt="" />
            </Link>
          </div>
          ...
          <div
            className="frame_input_and_label_sigup"
            style={{ marginTop: '50px' }}
          >
            <label className="label_sigup">Tên Đăng Nhập : </label>
            <input
              className="input_Name_sigup "
          ...
          <div className="frame_input_and_label_sigup">
            ...
            <input
              className="input_Phone_sigup"
              onChange={(e) => SetDob(e.target.value)}
              name=""
              id="pass"
              placeholder="vd: 22-05-2001"
            ></input>
          </div>
          <div className="frame_input_and_label_sigup">
            <label className="label_sigup"> Giới Tính : </label>
            <input
              className="input_gender_sigup"
